...
import org.kamsoft.ilschool.util.GmailSender;
import org.kamsoft.ilschool.util.Utils;
...
public class BackgroundMail {
    ...
    public BackgroundMail(Context context) {
        ...
        this.sendingMessageSuccess = "email sent successfully";
        this.sendingMessageError="error sending email";
    }
